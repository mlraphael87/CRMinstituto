...
function TermoConteudo({ order, paciente, unidade, cidadeAssinatura, dataHoje }) {
  ...
  <div className="imv-term-page rounded-xl p-6" style={{ background: "#fff", fontFamily: "Arial, Helvetica, sans-serif", color: "#111" }}>
            <TermoLogo />
            <h2 className="text-center font-extrabold" style={{ fontSize: 25.6, lineHeight: "normal", marginTop: "1.5cm" }}>Termo de Recebimento</h2>
            <p className="mt-0.5 text-center font-semibold text-gray-500" style={{ fontSize: 16.4, lineHeight: "normal" }}>PROJETO SAÚDE AUDITIVA – INSTITUTO MAÇÔNICO OUVIR - IMOUVIR</p>
            <p className="mt-1 leading-snug" style={{ fontSize: 16.4, lineHeight: "normal" }}>
            ...
            <p className="mt-1 font-bold text-center" style={{ fontSize: 16.4, lineHeight: "normal" }}>{order.numero} - PCT {(paciente?.nome || "").toUpperCase()}</p>

            <table className="mt-1 w-full border-collapse leading-snug" style={{ fontSize: 15.9, lineHeight: "normal" }}>
              <tbody>
            ...
            <p className="mt-1 font-bold uppercase leading-snug text-center" style={{ fontSize: 15.9, lineHeight: "normal" }}>
            ...
            <h3 className="mt-1 font-extrabold" style={{ fontSize: 18.8, lineHeight: "normal" }}>Cuidados a serem observados para preservação do Aparelho Auditivo</h3>
            <ul className="mt-1 list-disc space-y-0 pl-5 leading-snug" style={{ fontSize: 14.6, lineHeight: "normal" }}>
            ...
            <div className="text-center imv-avoid-break" style={{ fontSize: 12.5, lineHeight: "normal", marginTop: "2.5cm" }}>
          ...
          <div className="imv-page-2 imv-term-page rounded-xl p-6" style={{ background: "#fff", fontFamily: "Arial, Helvetica, sans-serif", color: "#111" }}>
            <TermoLogo />
            <h2 className="text-center font-extrabold" style={{ fontSize: 21, lineHeight: "normal", marginTop: "1.5cm" }}>TERMO DE RESPONSABILIDADE E AUTORIZAÇÃO<br />DE USO E DIREITOS DE IMAGEM INDIVIDUAL</h2>
            <p className="mt-0.5 leading-tight" style={{ fontSize: 14.6, lineHeight: "normal" }}>
            ...
            <table className="mt-0 w-full border-collapse leading-snug imv-avoid-break" style={{ fontSize: 15.1, lineHeight: "normal" }}>
              <tbody>
            ...
            <p className="mt-0 leading-tight" style={{ fontSize: 13.8, lineHeight: "normal" }}>
