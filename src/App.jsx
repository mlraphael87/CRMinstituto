...
function TermoLogo() {
  return (
    <div className="flex justify-center">
      <img src={imouvirLogo} alt="IMOUVIR" style={{ height: 147, objectFit: "contain" }} />
    </div>
  );
}
...
function TermoConteudo({ order, paciente, unidade, cidadeAssinatura, dataHoje }) {
  ...
  <div className="imv-term-page rounded-xl p-6" style={{ background: "#fff", fontFamily: "Arial, Helvetica, sans-serif", color: "#111" }}>
            <TermoLogo />
            <h2 className="text-center font-extrabold" style={{ fontSize: 12.3, lineHeight: "calc(1em + 4mm)", marginTop: "1.5cm" }}>Termo de Recebimento</h2>
            <p className="mt-0.5 text-center font-semibold text-gray-500" style={{ fontSize: 7.9, lineHeight: "calc(1em + 4mm)" }}>PROJETO SAÚDE AUDITIVA – INSTITUTO MAÇÔNICO OUVIR - IMOUVIR</p>
            <p className="mt-1 leading-snug" style={{ fontSize: 7.9, lineHeight: "calc(1em + 4mm)" }}>
            ...
            <p className="mt-1 font-bold text-center" style={{ fontSize: 7.9, lineHeight: "calc(1em + 4mm)" }}>{order.numero} - PCT {(paciente?.nome || "").toUpperCase()}</p>

            <table className="mt-1 w-full border-collapse leading-snug" style={{ fontSize: 7.6, lineHeight: "calc(1em + 4mm)" }}>
              <tbody>
            ...
            <p className="mt-1 font-bold uppercase leading-snug text-center" style={{ fontSize: 7.6, lineHeight: "calc(1em + 4mm)" }}>
            ...
            <h3 className="mt-1 font-extrabold" style={{ fontSize: 9.1, lineHeight: "calc(1em + 4mm)" }}>Cuidados a serem observados para preservação do Aparelho Auditivo</h3>
            <ul className="mt-1 list-disc space-y-0 pl-5 leading-snug" style={{ fontSize: 7.1, lineHeight: "calc(1em + 4mm)" }}>
            ...
            <div className="text-center imv-avoid-break" style={{ fontSize: 6, lineHeight: "normal", marginTop: "3cm" }}>
          ...
          <div className="imv-page-2 imv-term-page rounded-xl p-6" style={{ background: "#fff", fontFamily: "Arial, Helvetica, sans-serif", color: "#111" }}>
            <TermoLogo />
            <h2 className="text-center font-extrabold" style={{ fontSize: 10.1, lineHeight: "calc(1em + 4mm)", marginTop: "1.5cm" }}>TERMO DE RESPONSABILIDADE E AUTORIZAÇÃO<br />DE USO E DIREITOS DE IMAGEM INDIVIDUAL</h2>
            <p className="mt-0.5 leading-tight" style={{ fontSize: 7.1, lineHeight: "calc(1em + 4mm)" }}>
            ...
            <table className="mt-0 w-full border-collapse leading-snug imv-avoid-break" style={{ fontSize: 7.2, lineHeight: "calc(1em + 4mm)" }}>
              <tbody>
            ...
            <p className="mt-0 leading-tight" style={{ fontSize: 6.6, lineHeight: "calc(1em + 4mm)" }}>
