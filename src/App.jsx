...
function TermoConteudo({ order, paciente, unidade, cidadeAssinatura, dataHoje }) {
  ...
  <div className="imv-term-page rounded-xl p-6" style={{ background: "#fff", fontFamily: "Arial, Helvetica, sans-serif", color: "#111" }}>
            <TermoLogo />
            <h2 className="mt-1.5 text-center font-extrabold" style={{ fontSize: 28 }}>Termo de Recebimento</h2>
            <p className="mt-0.5 text-center font-semibold text-gray-500" style={{ fontSize: 18 }}>PROJETO SAÚDE AUDITIVA – INSTITUTO MAÇÔNICO OUVIR - IMOUVIR</p>
            <p className="mt-1 leading-snug" style={{ fontSize: 18 }}>
            ...
            <p className="mt-1 font-bold text-center" style={{ fontSize: 18 }}>{order.numero} - PCT {(paciente?.nome || "").toUpperCase()}</p>

            <table className="mt-1 w-full border-collapse leading-snug" style={{ fontSize: 17.5 }}>
              <tbody>
            ...
            <p className="mt-1 font-bold uppercase leading-snug text-center" style={{ fontSize: 17.5 }}>
            ...
            <h3 className="mt-1 font-extrabold" style={{ fontSize: 20.5 }}>Cuidados a serem observados para preservação do Aparelho Auditivo</h3>
            <ul className="mt-1 list-disc space-y-0 pl-5 leading-snug" style={{ fontSize: 16 }}>
            ...
            <div className="mt-0.5 text-center imv-avoid-break" style={{ fontSize: 16 }}>
          ...
          <div className="imv-page-2 imv-term-page rounded-xl p-6" style={{ background: "#fff", fontFamily: "Arial, Helvetica, sans-serif", color: "#111" }}>
            <TermoLogo />
            <h2 className="mt-1 text-center font-extrabold" style={{ fontSize: 23 }}>TERMO DE RESPONSABILIDADE E AUTORIZAÇÃO<br />DE USO E DIREITOS DE IMAGEM INDIVIDUAL</h2>
            <p className="mt-1 leading-tight" style={{ fontSize: 16 }}>
            ...
            <table className="mt-0.5 w-full border-collapse leading-snug imv-avoid-break" style={{ fontSize: 16.5 }}>
              <tbody>
            ...
            <p className="mt-0.5 leading-tight" style={{ fontSize: 15.2 }}>
